...
public class CustomAuthenticattionFilter extends UsernamePasswordAuthenticationFilter {
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(CustomAuthenticattionFilter.class);

	public CustomAuthenticattionFilter(AuthenticationManager authenticationManager) {
